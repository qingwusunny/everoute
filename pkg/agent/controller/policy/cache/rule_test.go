...
func TestRuleReverse(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			name: "without port",
			rule: PolicyRule{
				Name:            "default/test-without-port/normal/ingress.ingress1",
				Action:          RuleActionDrop,
				PriorityOffset:  30,
				RuleType:        RuleTypeNormalRule,
			...
			exp: PolicyRule{
				Name:            "default/test-without-port/normal/ingress.ingress1-ycpj5nwmp19cvivz0kxwbjkvulr395so",
				Action:          RuleActionDrop,
				PriorityOffset:  30,
				RuleType:        RuleTypeNormalRule,
		...
		},
		{
			name: "with dst port",
			rule: PolicyRule{
				Name:            "default/test-without-port/normal/egress.egress1",
				Action:          RuleActionDrop,
				PriorityOffset:  30,
				RuleType:        RuleTypeNormalRule,
				Direction:       RuleDirectionOut,
			...
			exp: PolicyRule{
				Name:            "default/test-without-port/normal/egress.egress1-xt3q6njpwva1onfdi2l2j5saticwcbit",
				Action:          RuleActionDrop,
				PriorityOffset:  30,
				RuleType:        RuleTypeNormalRule,
				Direction:       RuleDirectionIn,
